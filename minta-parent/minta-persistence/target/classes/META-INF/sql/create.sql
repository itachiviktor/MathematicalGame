...
CREATE TABLE NUMBER( columnindex INT, lineindex INT, nvalue INT, lifecycle VARCHAR2(50), muserfk BIGINT, fieldfk BIGINT, PRIMARY KEY(fieldfk, columnindex, lineindex), FOREIGN KEY(muserfk) references MUSER(userID),FOREIGN KEY(fieldfk) references FIELD(fieldID));